...
export const CLIENT_IMPORT_FIELDS: CsvFieldSpec[] = [
  { column: 'full_name', label: 'Nom complet', required: true, example: 'Ahmed Benali' },
  { column: 'phone', label: 'Téléphone', required: true, example: '0555 12 34 56' },
  { column: 'email', label: 'Email', example: 'ahmed.benali@gmail.com' },
  { column: 'nin_cin', label: 'NIN / CIN', example: '123456789012345678' },
  { column: 'client_type', label: 'Type de client', transform: normaliseClientType, hint: 'Particulier / Entreprise', example: 'Particulier' },
  { column: 'source', label: 'Source', required: true, transform: normaliseSource, hint: 'facebook, google, site web, etc.', example: 'Facebook Ads' },
  { column: 'pipeline_stage', label: 'Étape pipeline', transform: normaliseStage, hint: 'accueil par défaut', example: 'Accueil' },
  { column: 'interest_level', label: 'Niveau d\'intérêt', transform: normaliseInterest, example: 'Moyen' },
  { column: 'confirmed_budget', label: 'Budget confirmé', transform: (r) => parseNumber(r), example: '12000000' },
  { column: 'profession', label: 'Profession', example: 'Ingénieur' },
  { column: 'address', label: 'Adresse', example: 'Cité El-Kiffan, Alger' },
  { column: 'nationality', label: 'Nationalité', hint: 'Code pays, défaut DZ', example: 'DZ' },
  { column: 'birth_date', label: 'Date de naissance', transform: (r) => parseDate(r), example: '15/06/1985' },
  { column: 'notes', label: 'Notes', example: 'Intéressé par un F3, budget flexible' },
]
