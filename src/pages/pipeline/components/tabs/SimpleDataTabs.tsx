...
export function NotesTab({ clientId }: { clientId: string }) {
  ...
  // eslint-disable-next-line react-hooks/immutability, react-hooks/exhaustive-deps -- saveTimerRef is a ref; mutating .current is the idiomatic debounce pattern
