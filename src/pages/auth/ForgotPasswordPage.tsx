        ...
        <div className="rounded-2xl border border-[#E3E8EF] bg-white p-8 shadow-xl shadow-black/[0.03] sm:p-10">
          {success ? (
            <div className="text-center">
              ...
              <h1 className="text-[20px]" style={{fontWeight:800,color:'#0A2540'}}>Email envoyé</h1>
              <p className="mt-3 text-[14px] leading-relaxed text-[#8898AA]">
                Si un compte est associé à cette adresse, vous recevrez un email avec un lien de réinitialisation.
              </p>
            ...
            <>
              <div className="mb-6">
                <h1 className="text-[22px]" style={{fontWeight:800,color:'#0A2540',letterSpacing:'-0.3px'}}>Mot de passe oublié</h1>
                <p className="mt-1 text-[14px] text-[#8898AA]">Entrez votre email — nous vous enverrons un lien pour réinitialiser votre mot de passe.</p>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div>
                  <label htmlFor="email" className="mb-1.5 block text-[12px] text-[#425466]" style={{fontWeight:600}}>Email</label>
